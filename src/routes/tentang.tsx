  ...
  head: () => ({
    meta: [
      { title: "Tentang Kami — Kaito Hiro (KTH)" },
      {
        name: "description",
        content:
          "Sejarah, visi, misi, dan komitmen Kaito Hiro sebagai produsen pompa air premium di Indonesia.",
      },
    ...
    <>
      ...
      <div className="relative w-full h-[55vh] md:h-[65vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-12 md:pb-16 mx-auto max-w-7xl container-px">
          ...
          >
            <div className="text-xs uppercase tracking-[0.25em] text-accent-orange font-bold mb-4">
              Tentang Kami
            </div>
            ...
            <p className="mt-5 text-white/70 text-lg max-w-2xl leading-relaxed">
              Lebih dari 10 tahun menghadirkan pompa air berkualitas dan menjadi mitra terpercaya
        ...
        <Reveal>
          ...
          <blockquote className="mt-8 pl-6 border-l-4 border-accent-orange">
            <p className="text-xl font-medium text-foreground/80 italic leading-relaxed">
              "Kami percaya setiap keluarga Indonesia berhak mendapatkan air bersih yang cukup,
              kapan pun dibutuhkan."
            </p>
            <footer className="mt-3 text-sm text-muted-foreground font-semibold">
              — Pendiri, Kaito Hiro
            </footer>
          </blockquote>
          <p className="mt-7 text-muted-foreground leading-relaxed">
            Kaito Hiro (KTH) didirikan pada tahun 2015 dengan satu tujuan sederhana: menghadirkan
            pompa air berkualitas tinggi yang terjangkau bagi keluarga Indonesia. Dimulai dari
            workshop kecil di Jakarta, kini KTH menjadi salah satu merek pompa air paling dipercaya
            dengan jaringan <strong className="text-foreground">150+ distributor</strong> dan ribuan
            agen di seluruh nusantara.
          </p>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Setiap pompa KTH dibuat dengan komponen premium — motor 100% kawat tembaga, gantungan
            kuningan, dan body anti karat — yang dijamin garansi resmi ganti unit baru selama 1
            tahun.
          </p>
        </Reveal>
        <Reveal delay={0.1}>
          <div className="grid grid-cols-2 gap-4">
            <img
              ...
              alt="Gudang KTH"
              loading="lazy"
              className="aspect-[3/4] w-full rounded-3xl object-cover shadow-elegant"
            />
            <img
              src={team}
              alt="Tim KTH"
              loading="lazy"
              className="aspect-[3/4] w-full rounded-3xl object-cover shadow-elegant mt-8"
            />
          </div>
        </Reveal>
      </section>
          ...
          <Reveal>
            <div className="h-full">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Menjadi perusahaan pompa terkemuka yang memperkuat brand skala nasional dengan
                mengedepankan kualitas, pelayanan, dan kepuasan pelanggan.
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <span className="h-6 w-6 rounded-full bg-accent-orange/15 text-accent-orange text-xs font-bold grid place-items-center shrink-0 mt-0.5">
                      {i + 1}
                    </span>
          ...
          {[
            {
              ...
              label: "01",
              t: "Pelanggan #1",
              d: "Kepuasan pelanggan adalah prioritas utama dalam setiap keputusan yang kami ambil.",
            ...
            },
            {
              ...
              label: "02",
              t: "Kualitas Premium",
              d: "Standar tinggi untuk setiap komponen, proses produksi, dan unit yang kami kirimkan.",
            ...
            },
            {
              ...
              label: "03",
              t: "Inovasi",
              d: "Terus mengembangkan produk yang lebih efisien, hemat energi, dan mudah dirawat.",
            ...
            },
            {
              ...
              label: "04",
              t: "Transparansi",
              d: "Komunikasi terbuka dan jujur dengan seluruh mitra, distributor, dan pelanggan.",
            ...
            <Reveal key={i} delay={i * 0.06}>
              <div className="p-7 rounded-2xl border border-border hover:shadow-soft transition-shadow h-full">
                ...
                <div className="text-[10px] text-muted-foreground font-bold tracking-widest mb-1">
                  {v.label}
                </div>
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="font-display font-extrabold text-2xl md:text-3xl">
                Bergabung Bersama 150+ Distributor KTH
              </h3>
              <p className="mt-3 text-white/70 leading-relaxed">
                Jadilah bagian dari jaringan distribusi pompa air terpercaya di Indonesia dan raih
