...
import { LayoutDashboard, Package, Newspaper, Inbox, LogOut, Home, Building2, Download } from "lucide-react";
        ...
        <aside className="lg:sticky lg:top-24 self-start">
          <div className="rounded-2xl border border-border bg-card p-4 shadow-soft">
            <div className="px-2 py-3 border-b border-border mb-3">
              <div className="text-[10px] uppercase tracking-widest text-muted-foreground">Logged in as</div>
