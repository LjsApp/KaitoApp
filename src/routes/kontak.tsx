...
export const Route = createFileRoute("/kontak")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Hubungi tim Kaito Hiro untuk konsultasi pompa air dan layanan purna jual.",
      },
...
function KontakPage() {
  ...
  return (
    <>
          ...
          <div className="max-w-xl">
            <Reveal>
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-10">
                Punya pertanyaan tentang produk? Ingin klaim garansi? Atau tertarik menjadi
                distributor resmi KTH? Tim ahli kami selalu siap sedia.
              </p>
            </Reveal>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Kunjungi kantor pusat kami atau hubungi melalui saluran resmi KTH.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ContactRow
                ...
                desc={SITE.working_hours || "Senin – Sabtu, 08.00–17.00 WIB"}
              />
            </div>
          </div>
              ...
              <div className="bg-card border border-border shadow-elegant rounded-3xl p-8 md:p-10">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Isi formulir di bawah ini dan kami akan membalas email Anda dalam 1x24 jam.
                  </p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-5">
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    <Field label="Nama Lengkap">
                      <input
                        name="name"
                        required
                        className="w-full h-12 bg-muted border border-border rounded-xl px-4 text-sm outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all placeholder:text-muted-foreground"
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    ...
                    <Field label="Subjek Pesan">
                      <select
                        name="subject"
                        required
                        className="w-full h-12 bg-muted border border-border rounded-xl px-4 text-sm outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all"
                      >
                  ...
                  <Field label="Pesan Anda">
                    <textarea
                      ...
                      rows={5}
                      required
                      className="w-full bg-muted border border-border rounded-xl p-4 text-sm outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all resize-none placeholder:text-muted-foreground"
                  ...
                  <div className="pt-2">
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full sm:w-auto bg-primary text-primary-foreground font-bold h-12 px-8 rounded-xl hover:opacity-90 transition-opacity"
                      disabled={loading}
                    >
                      {loading ? (
                        "Mengirim..."
      ...
      {SITE.map_embed ? (
        <div className="rounded-3xl overflow-hidden shadow-soft h-[350px] lg:h-[450px] bg-card border border-border/50 relative group">
          <div
            className="w-full h-full [&_iframe]:w-full [&_iframe]:h-full [&_iframe]:border-0"
            dangerouslySetInnerHTML={{
              __html: DOMPurify.sanitize(SITE.map_embed, {
                ALLOWED_TAGS: ["iframe"],
                ALLOWED_ATTR: [
                  "src",
                  "width",
          ...
          />
          <div className="absolute inset-0 pointer-events-none rounded-3xl ring-1 ring-inset ring-foreground/10" />
        </div>
      ) : SITE.address ? (
